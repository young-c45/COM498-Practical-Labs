...
public class BagTest {
    ...
    public static void main(String[] args) {
        ...
        ArrayBag<String> testArrayBag = new ArrayBag<>();
        System.out.println("------------------------------------------------------");
        ...
        // Add the following strings to the bag: "A", "A", "B", "B". "C", "C", "D", "D":
        ...
        // Remove an unspecified entry from the bag:
        testArrayBag.remove();
        ...
        // Remove another unspecified entry from the bag:
        testArrayBag.remove();
